...
@Setter
@NoArgsConstructor
public class BilligesFleisch implements Produkt {

    public BilligesFleisch(String bezeichnung, int qualitat, int preis) {
    ...
    public BilligesFleisch(int qualitat, String bezeichnung, double preis, LocalDateTime verfallsdatum) {
        this.qualitat = qualitat;
        this.bezeichnung = bezeichnung;
        this.preis = preis;
    ...
    public boolean equals(Object o) {
        ...
        BilligesFleisch kase = (BilligesFleisch) o;
